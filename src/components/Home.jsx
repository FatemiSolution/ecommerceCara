...
<section className="banner3 sm-banner">
  <div className="banner-box">
      <h2>SEASONS SALES</h2>
      <span>Winter Collections, 50% off</span>
     
  </div>
  <div className="banner-box banner-box2" style={{backgroundImage:`url(images/banner/b4.jpg)`}}>

      <h2>NEW COLLECTION</h2>
      <span>spring/summer 2023</span>
  </div>
  <div className="banner-box banner-box2" style={{backgroundImage:'url(images/banner/b18.jpg)'}}>
      <h2>T-SHIRTS</h2>
